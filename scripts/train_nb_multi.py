...
# Pipeline: TF-IDF + One-vs-Rest MultinomialNB
pipe = Pipeline(
    [
        (
            "tfidf",
...
# Log to MLflow
with mlflow.start_run(run_name="nb_ovr_multilabel"):
    mlflow.log_param("model", "mnb_ovr")
    mlflow.log_param("vectorizer", "tfidf_50k_1-2gram_sublinear")
...
print(f"NB OVR  f1_micro={f1_micro:.4f}  f1_macro={f1_macro:.4f}")
